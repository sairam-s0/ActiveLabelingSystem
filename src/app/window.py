...
from core.sam_adapter import sam_available
...
class TopControlBar(QFrame):
    ...
    def __init__(self):
        ...
        self.setStyleSheet(f"background-color: {COLORS['panel']}; border-bottom: 2px solid {COLORS['border']};")
        self._setup_ui()
...
class LeftSidePanel(QFrame):
    ...
    def _setup_ui(self, layout):
        ...
        al_panel = QFrame()
        al_panel.setStyleSheet(f"background-color: {COLORS['bg']}; border-radius: 6px; padding: 10px; border: none;")
        ...
        train_panel = QFrame()
        train_panel.setStyleSheet(f"background-color: {COLORS['bg']}; border-radius: 6px; padding: 10px; border: none;")
        ...
        version_panel.setStyleSheet(f"background-color: {COLORS['bg']}; border-radius: 6px; padding: 10px; border: none;")
...
class BottomActionBar(QFrame):
    ...
    def __init__(self):
        ...
        self.setStyleSheet(f"background-color: {COLORS['panel']}; border-top: 2px solid {COLORS['border']};")
        self._setup_ui()
...
class MainWindow(QMainWindow):
    ...
    def setup_ui(self):
        ...
        # splitter handle styled via global QSS
        ...
        canvas_container.setStyleSheet(f"background-color: {COLORS['bg']}; border: none;")
    ...
    def accept(self):
        ...
        state.current_index += 1
        self.top_bar.progress_label.setText("✓ Accepted")
        self.top_bar.progress_label.setStyleSheet(
            f"color: {COLORS['success']}; font-size: 12px; font-weight: bold;"
        )
    ...
    def reject(self):
        try:
            ...
            pass
        state.current_index += 1
        self.top_bar.progress_label.setText("✗ Rejected")
        self.top_bar.progress_label.setStyleSheet(
            f"color: {COLORS['danger']}; font-size: 12px; font-weight: bold;"
        )
        self.app.process_next()
